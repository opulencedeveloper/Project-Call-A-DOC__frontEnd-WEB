...
const MyChat = (props) => {
  ...
  return (
    <div className="relative h-[80%] flex-1  pb-5 bg-custom8 rounded-tl-2xl rounded-tr-2xl">
      ...
      <div
        ...
        className="overflow-y-auto grid justify-items-end h-full w-full pb-20 space-y-5 px-3 md:px-8"
      >
        {/* Chats here */}
        {props.userType === "doctor" &&
