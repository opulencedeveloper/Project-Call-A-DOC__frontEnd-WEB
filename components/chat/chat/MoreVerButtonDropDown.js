...
const MoreVertButtonDropDown = (props) => {
  const {
    scheduleCheckupHandler,
    endAppointmentHandler,
    moreVertButtonHandler,
  } = props;

  return (
    <div className="animateSlideDown z-50 absolute top-10 -right-1 h-[180px] w-[230px] flex flex-col items-center justify-center rounded-xl bg-white shadow-custom-shadow2 md:w-[306px] md:h-[220px]">
      <button
        onClick={() => {
          scheduleCheckupHandler();
          moreVertButtonHandler();
      ...
      <button
        onClick={() => {
          endAppointmentHandler(), moreVertButtonHandler();
        }}
