...
const AppointmentJourney = ({ endAppointmentHandler }) => {
  ...
  return (
    <div className="relative flex flex-col overflow-y-auto z-50 mx-3 relative items-center justify-center bg-custom1 space-y-4 p-8 rounded-2xl shadow-2xl md:p-20 ">
      {error && (
