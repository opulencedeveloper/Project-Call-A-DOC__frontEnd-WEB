  ...
  return (
    <section className="mb-20 md:mb-96">
      {contents.map((content) => {
        return (
          <div
            className="flex flex-col border-b border-custom1 bg-57B7FF lg:flex-row border-b-2 border-ash py-10 px-5 md:px-20"
            key={content.content1}
          >
            <div className="pt-auto text-custom1 space-y-10 md:pt-20 lg:pt-40">
              ...
              <p className="text-3xl pr-36 md:text-5xl md:pr-80">
                {content.content1}
              </p>
              <p className="text-md pr-10 md:pr-72">{content.content2}</p>
